...
async function executeShipmentUpdate(shipmentId, payload, backupCache) {
    ...
    try {
        const response = await fetch(`https://shipping-api-eight.vercel.app/address/update-shipment-data?id=${shipmentId}`, {
            method: "PUT",
            headers: {
...
async function executeInvoiceDispatch(shipmentId, payload) {
    ...
    try {
        const response = await fetch(`https://shipping-api-eight.vercel.app/address/invoice?id=${shipmentId}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`
...
async function executeReceiptDispatch(shipmentId, payload) {
    ...
    try {
        const response = await fetch(`https://shipping-api-eight.vercel.app/address/receipt?id=${shipmentId}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`
